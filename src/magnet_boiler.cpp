...
Magnet_boiler::Magnet_boiler(float x, float y, double length, double breadth, double angle, color_t color) {
...
void Magnet_boiler::draw(glm::mat4 VP) {
...
void Magnet_boiler::set_position(float x, float y) {
    this->position = glm::vec3(x, y, 0);
}

// This detect is only for horizontal magnet
bool Magnet_boiler::detect(Ball Player){
